...
@RestController
@RequestMapping("/api/elend-service-kafka")
public class ElendServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ElendServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ElendServiceKafkaResource(KafkaProperties kafkaProperties) {
